...
class CityMapper(Frame):
    def __init__(self):
        ...
        self.master.title("Mejor recorrido usando algoritmos genéticos sin el uso de DEAP")
    ...
    def draw_best_ui(self, cities, route, generation):
        ...
        self.canvas.create_text(
            ...
            anchor=NW,
            font=("Open Sans", 20),
            text=f"Generacion: {generation:03} \nDistancia : {route.distance:.3f}",
        )
...
# Algoritmos Genéticos sin el uso de DEAP
